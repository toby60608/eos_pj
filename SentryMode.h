...
typedef enum _ENUM_SENTRY_MODE_COMMAND_ID_T
{
	...
	ENUM_SENTRY_MODE_COMMAND_ID_TAKE_2S_VIDEO,
	...
	ENUM_SENTRY_MODE_COMMAND_ID_RESPONSE_TAKE_2S_VIDEO = ENUM_SENTRY_MODE_COMMAND_ID_RESPONSE | ENUM_SENTRY_MODE_COMMAND_ID_TAKE_2S_VIDEO,
